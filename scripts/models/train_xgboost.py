...
MODEL_FILE = "models_saved/xgboost.pkl"
PRED_FILE = "results/predictions/xgboost_xy_predictions.csv"
...
def main():
    ...
    model = MultiOutputRegressor(XGBRegressor(n_estimators=500, max_depth=5, learning_rate=0.03, subsample=0.85, colsample_bytree=0.85, objective="reg:squarederror", random_state=42, n_jobs=-1))
