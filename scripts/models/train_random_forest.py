...
MODEL_FILE = "models_saved/random_forest.pkl"
PRED_FILE = "results/predictions/random_forest_xy_predictions.csv"
...
def main():
    ...
    model = MultiOutputRegressor(RandomForestRegressor(n_estimators=500, random_state=42, n_jobs=-1, min_samples_leaf=2))
