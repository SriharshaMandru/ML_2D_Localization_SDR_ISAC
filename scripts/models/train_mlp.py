...
MODEL_FILE = "models_saved/mlp.pkl"
PRED_FILE = "results/predictions/mlp_xy_predictions.csv"
...
def main():
    ...
    model = Pipeline([('scaler', StandardScaler()), ('mlp', MLPRegressor(hidden_layer_sizes=(128, 64, 32), max_iter=1000, random_state=42))])
