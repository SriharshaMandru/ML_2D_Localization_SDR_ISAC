...
MODEL_FILE = "models_saved/extra_trees.pkl"
PRED_FILE = "results/predictions/extra_trees_xy_predictions.csv"
...
def main():
    ...
    model = MultiOutputRegressor(ExtraTreesRegressor(n_estimators=500, random_state=42, n_jobs=-1, min_samples_leaf=2))
